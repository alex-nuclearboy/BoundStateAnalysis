...
//Selection criteria for the analysis of the experimental data of the pd -> (3He-eta)_bound -> pdpi0 -> pd2g reaction
    ...
    if (gWasa->IsAnalysisMode(Wasa::kMCRaw)||
        ...
        while (WVertex* vert = dynamic_cast<WVertex*>(vIt.Next())) {    //A02//
            ...
            for (Int_t particleindex = 0; particleindex < vert->NumberOfParticles(); particleindex++) {     //A03//
                ...
                //gamma #1//
                if ((NrVertex == 1) && (PType == 1) && (particleindex == 2)) {  //g1//
                ...
                //gamma #2//
                if ((NrVertex == 1) && (PType == 1) && (particleindex == 3)) {  //g2//
